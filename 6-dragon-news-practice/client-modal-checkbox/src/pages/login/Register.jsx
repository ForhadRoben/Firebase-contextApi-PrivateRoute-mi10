                ...
                <div className="card  w-full lg:w-50 shadow-2xl bg-base-100 p-5">
                    <form onSubmit={handleRegister} className="card-body">
                        ...
                        <div className="flex">
                            ...
                            <input type="checkbox" onClick={handleAccepted} name="accept" className="checkbox checkbox-info" />
                            <label >
                                <span className="label-text">Accept <Link to='/terms' className="underline text-blue-500">terms and conditions</Link> </span>
                            </label>
