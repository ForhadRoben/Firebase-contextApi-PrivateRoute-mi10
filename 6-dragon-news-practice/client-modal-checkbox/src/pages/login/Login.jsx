                    ...
                    <form onSubmit={handleLogin} className="card-body">
                        ...
                        <div className="form-control">
                            ...
                            <div className="flex items-center justify-center relative">
                                <input type={show ? 'text' : 'password'} name="password" placeholder="password" className="input input-bordered flex-grow" required />
                                {/* password show */}
                                <button onClick={() => setShow(!show)} className="text-2xl absolute right-8 ">
                                    {
